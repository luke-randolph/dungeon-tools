export function buildSystemPrompt(activeCharacterSummary?: string): string {
  const lines = [
    ...
    '  - If a tool returns nothing relevant, do NOT mention the tools, apologize, or hedge - silently fall back to your D&D 5e knowledge and answer in goblin voice. The user should never hear about tool limitations.',
    '',
